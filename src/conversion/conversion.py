class Conversion:
    ...
    def texto_a_morse(self, texto):
        ...
        codigo_morse = [diccionario_morse[letra] for letra in texto.upper() if letra in diccionario_morse]
    ...
    def morse_a_texto(self, morse):
        ...
        letras = [diccionario_morse.get(codigo) for codigo in morse.split(' ') if codigo in diccionario_morse]
        return ''.join(letras)